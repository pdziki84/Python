#Mad Lib
# opowiadanie oparte a szczegółach wprowadzonych przez uzytkownika
...
class Application(Frame):
    ...
    def create_widgets(self):
        ...
        Label(self,
              text = "Wprowadź informacje do nowego opowaidania"
        ...
        # utwórz etykietę do pł wyboru przymiotnikó
        Label(self,
              text = "Przymiotnik(i) : "
        ...
        #utwórz ple wyboru przymiotnika 'elektryzujące'
        ...
        #utwórz zmienną na pojedynczą czzęść ciała
        self.body_part = StringVar()
        self.body_part.set(None)

        #utwórz przyciski opcji odnoszącyc się do części ciałą
        ...
        #utwórz prrzycisk akceptacji danych
        Button(self,
