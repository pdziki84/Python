#Turniej wiedzy
#Gra sprawdzajaca wiedzę ogólną, odczytującą dane ze zwykłego pliku telstowego
...
def open_file(file_name, mode):
    ...
    try:
        ...
        print("\nNIe można otworzyć pliku", fil_name, "Program zostanie zakończony.\n", e)
...
def main():
    ...
    while(category):
        ...
        #sprawdź odpowiedz
        if(answer == correct):
            print("\nOdpowedź prawidłowa!", end=" ")
            score += 1
        else:
            print("\nOdpowedź nieprawidłowa.", end=" ")
        print(explanation)
        print("Wynik:", score, "\n\n")
